	...
	<div class="px-4 py-5 sm:p-6 w-full">
		{#if title != 'Add'}
			<button
				class="mr-0 ml-auto"
				on:click={() => {
					exchange_to_delete = title.toLowerCase();
				}}
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 24 24"
					class="h-6 w-6 mr-0 ml-auto fill-current"
		...
		{/if}
		<div class:-mt-6={title != 'Add'} class="items-center text-center">
